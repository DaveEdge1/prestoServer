...
const seasonality1 = function (hide1, defaultChoice1, tooltip1, hide2, offByDefault2, defaultRange2, tooltip2) {
	...
	console.log("offByDefault2: " + offByDefault2)
...
const makeRect = function (recon){
	...
	return String.raw`let rect = L.rectangle([[`+coords[0]+`, `+coords[2]+`], [`+coords[1]+`, `+coords[3]+`]], { color: "#ff7800", opacity:0.1, fill: "#ff7800", fillOpacity:0.1, draggable: true });` + `\n`
}
...
+ String.raw` "Peat":"#8A9A5B","Sclerosponge":"#D2042D","Shoreline":"#40826D","Wood":"#32CC32","TerrestrialSediment":"#d2b48c", "Documents": "#000000"}` + `\n`
...
+ String.raw` "Peat":"triangle-down","Sclerosponge":"triangle-down","Shoreline":"diamond","Wood":"triangle","TerrestrialSediment":"circle", "Documents": "star-5"}` + `\n`
...
+ String.raw`			var radius1 = 4` + `\n`
+ String.raw`			if (aType == "Documents"){` + `\n`
+ String.raw`				radius1 = 6` + `\n`
+ String.raw`			}` `\n`
...
+ String.raw`				resolve("/editor/querypath"+window.location.search+queryParams)` + `\n`
+ String.raw`			} else {` + `\n`
