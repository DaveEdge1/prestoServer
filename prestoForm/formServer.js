...
app.post('/manualORdefault', function (req, res) {
	...
	//var downloadpath = 'http://137.184.4.96:81/' + req.query.recon +  '/' + req.query.email.split('@')[0] + '/' + req.query.email.split('@')[1] + '/default'
        var editorpath = function() { return ('http://137.184.4.96:85/?recon=' + req.query.recon + '&user=' + req.query.email.split('@')[0] + '&domain=' + req.query.email.split('@')[1] + '&uniqueID=' + req.query.uniqueID)}
