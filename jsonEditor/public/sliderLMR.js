...
const recon_period_fromInput = document.getElementById("recon_period_fromInput");
const recon_period_toInput = document.getElementById("recon_period_toInput");
fillSlider(recon_period_fromSilder, recon_period_toSilder, "#C6C6C6", "#896A67", recon_period_toSilder);
setToggleAccessible(recon_period_toSilder);
recon_period_fromSilder.oninput = () => controlFromSlider(recon_period_fromSilder, recon_period_toSilder, recon_period_fromInput);
recon_period_toSilder.oninput = () => controlToSlider(recon_period_fromSilder, recon_period_toSilder, recon_period_toInput);
recon_period_fromInput.onchange = () => controlFromInput(recon_period_fromSilder, recon_period_fromInput, recon_period_toInput, recon_period_toSilder);
recon_period_toInput.onchange = () => controlToInput(recon_period_toSilder, recon_period_fromInput, recon_period_toInput, recon_period_toSilder);
const prior_anom_period_fromSilder = document.getElementById("prior_anom_period_fromSilder");
const prior_anom_period_toSilder = document.getElementById("prior_anom_period_toSilder");
const prior_anom_period_fromInput = document.getElementById("prior_anom_period_fromInput");
const prior_anom_period_toInput = document.getElementById("prior_anom_period_toInput");
fillSlider(prior_anom_period_fromSilder, prior_anom_period_toSilder, "#C6C6C6", "#896A67", prior_anom_period_toSilder);
setToggleAccessible(prior_anom_period_toSilder);
prior_anom_period_fromSilder.oninput = () => controlFromSlider(prior_anom_period_fromSilder, prior_anom_period_toSilder, prior_anom_period_fromInput);
prior_anom_period_toSilder.oninput = () => controlToSlider(prior_anom_period_fromSilder, prior_anom_period_toSilder, prior_anom_period_toInput);
prior_anom_period_fromInput.onchange = () => controlFromInput(prior_anom_period_fromSilder, prior_anom_period_fromInput, prior_anom_period_toInput, prior_anom_period_toSilder);
prior_anom_period_toInput.onchange = () => controlToInput(prior_anom_period_toSilder, prior_anom_period_fromInput, prior_anom_period_toInput, prior_anom_period_toSilder);
const recon_loc_radSilder = document.getElementById("recon_loc_radSilder");
const recon_loc_radInput = document.getElementById("recon_loc_radInput");
recon_loc_radSilder.oninput = () => changeInput(recon_loc_radSilder, recon_loc_radInput);
recon_loc_radInput.onchange = () => changeSlider(recon_loc_radInput, recon_loc_radSilder);
fillSingleSlider(recon_loc_radSilder)
const proxy_assim_fracSilder = document.getElementById("proxy_assim_fracSilder");
const proxy_assim_fracInput = document.getElementById("proxy_assim_fracInput");
proxy_assim_fracSilder.oninput = () => changeInput(proxy_assim_fracSilder, proxy_assim_fracInput);
proxy_assim_fracInput.onchange = () => changeSlider(proxy_assim_fracInput, proxy_assim_fracSilder);
fillSingleSlider(proxy_assim_fracSilder)
const proxy_nensSilder = document.getElementById("proxy_nensSilder");
const proxy_nensInput = document.getElementById("proxy_nensInput");
proxy_nensSilder.oninput = () => changeInput(proxy_nensSilder, proxy_nensInput);
proxy_nensInput.onchange = () => changeSlider(proxy_nensInput, proxy_nensSilder);
fillSingleSlider(proxy_nensSilder)
var data_selection_archive_types_checkCycle = 0;
function data_selection_archive_types_incrementCheckCycle(){
...
return (prior_annualize_months_checkCycle);
}
