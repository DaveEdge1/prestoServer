...
const prior_model_interval_fromSilder = document.getElementById("prior_model_interval_fromSilder");
const prior_model_interval_toSilder = document.getElementById("prior_model_interval_toSilder");
const prior_model_interval_fromInput = document.getElementById("prior_model_interval_fromInput");
const prior_model_interval_toInput = document.getElementById("prior_model_interval_toInput");
fillSlider(prior_model_interval_fromSilder, prior_model_interval_toSilder, "#C6C6C6", "#896A67", prior_model_interval_toSilder);
setToggleAccessible(prior_model_interval_toSilder);
prior_model_interval_fromSilder.oninput = () => controlFromSlider(prior_model_interval_fromSilder, prior_model_interval_toSilder, prior_model_interval_fromInput);
