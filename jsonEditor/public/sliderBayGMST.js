...
const stan_iter_warmupSilder = document.getElementById("stan_iter_warmupSilder");
const stan_iter_warmupInput = document.getElementById("stan_iter_warmupInput");
stan_iter_warmupSilder.oninput = () => changeInput(stan_iter_warmupSilder, stan_iter_warmupInput);
stan_iter_warmupInput.onchange = () => changeSlider(stan_iter_warmupInput, stan_iter_warmupSilder);
fillSingleSlider(stan_iter_warmupSilder)
const stan_iter_samplingSilder = document.getElementById("stan_iter_samplingSilder");
const stan_iter_samplingInput = document.getElementById("stan_iter_samplingInput");
stan_iter_samplingSilder.oninput = () => changeInput(stan_iter_samplingSilder, stan_iter_samplingInput);
stan_iter_samplingInput.onchange = () => changeSlider(stan_iter_samplingInput, stan_iter_samplingSilder);
fillSingleSlider(stan_iter_samplingSilder)
const stan_chainsSilder = document.getElementById("stan_chainsSilder");
const stan_chainsInput = document.getElementById("stan_chainsInput");
stan_chainsSilder.oninput = () => changeInput(stan_chainsSilder, stan_chainsInput);
stan_chainsInput.onchange = () => changeSlider(stan_chainsInput, stan_chainsSilder);
fillSingleSlider(stan_chainsSilder)
const stan_parallel_chainsSilder = document.getElementById("stan_parallel_chainsSilder");
const stan_parallel_chainsInput = document.getElementById("stan_parallel_chainsInput");
stan_parallel_chainsSilder.oninput = () => changeInput(stan_parallel_chainsSilder, stan_parallel_chainsInput);
stan_parallel_chainsInput.onchange = () => changeSlider(stan_parallel_chainsInput, stan_parallel_chainsSilder);
fillSingleSlider(stan_parallel_chainsSilder)
const partition_t1Silder = document.getElementById("partition_t1Silder");
const partition_t1Input = document.getElementById("partition_t1Input");
partition_t1Silder.oninput = () => changeInput(partition_t1Silder, partition_t1Input);
partition_t1Input.onchange = () => changeSlider(partition_t1Input, partition_t1Silder);
fillSingleSlider(partition_t1Silder)
const partition_t2Silder = document.getElementById("partition_t2Silder");
const partition_t2Input = document.getElementById("partition_t2Input");
partition_t2Silder.oninput = () => changeInput(partition_t2Silder, partition_t2Input);
partition_t2Input.onchange = () => changeSlider(partition_t2Input, partition_t2Silder);
fillSingleSlider(partition_t2Silder)
const partition_t3Silder = document.getElementById("partition_t3Silder");
const partition_t3Input = document.getElementById("partition_t3Input");
partition_t3Silder.oninput = () => changeInput(partition_t3Silder, partition_t3Input);
partition_t3Input.onchange = () => changeSlider(partition_t3Input, partition_t3Silder);
fillSingleSlider(partition_t3Silder)
const co2_c0Silder = document.getElementById("co2_c0Silder");
const co2_c0Input = document.getElementById("co2_c0Input");
co2_c0Silder.oninput = () => changeInput(co2_c0Silder, co2_c0Input);
co2_c0Input.onchange = () => changeSlider(co2_c0Input, co2_c0Silder);
fillSingleSlider(co2_c0Silder)
const co2_co2_coefSilder = document.getElementById("co2_co2_coefSilder");
const co2_co2_coefInput = document.getElementById("co2_co2_coefInput");
co2_co2_coefSilder.oninput = () => changeInput(co2_co2_coefSilder, co2_co2_coefInput);
co2_co2_coefInput.onchange = () => changeSlider(co2_co2_coefInput, co2_co2_coefSilder);
fillSingleSlider(co2_co2_coefSilder)
const vol_vol_coefSilder = document.getElementById("vol_vol_coefSilder");
const vol_vol_coefInput = document.getElementById("vol_vol_coefInput");
vol_vol_coefSilder.oninput = () => changeInput(vol_vol_coefSilder, vol_vol_coefInput);
vol_vol_coefInput.onchange = () => changeSlider(vol_vol_coefInput, vol_vol_coefSilder);
fillSingleSlider(vol_vol_coefSilder)
