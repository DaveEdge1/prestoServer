...
const proxy_center_ref_period_fromSilder = document.getElementById("proxy_center_ref_period_fromSilder");
const proxy_center_ref_period_toSilder = document.getElementById("proxy_center_ref_period_toSilder");
const proxy_center_ref_period_fromInput = document.getElementById("proxy_center_ref_period_fromInput");
const proxy_center_ref_period_toInput = document.getElementById("proxy_center_ref_period_toInput");
fillSlider(proxy_center_ref_period_fromSilder, proxy_center_ref_period_toSilder, "#C6C6C6", "#896A67", proxy_center_ref_period_toSilder);
setToggleAccessible(proxy_center_ref_period_toSilder);
proxy_center_ref_period_fromSilder.oninput = () => controlFromSlider(proxy_center_ref_period_fromSilder, proxy_center_ref_period_toSilder, proxy_center_ref_period_fromInput);
proxy_center_ref_period_toSilder.oninput = () => controlToSlider(proxy_center_ref_period_fromSilder, proxy_center_ref_period_toSilder, proxy_center_ref_period_toInput);
proxy_center_ref_period_fromInput.onchange = () => controlFromInput(proxy_center_ref_period_fromSilder, proxy_center_ref_period_fromInput, proxy_center_ref_period_toInput, proxy_center_ref_period_toSilder);
proxy_center_ref_period_toInput.onchange = () => controlToInput(proxy_center_ref_period_toSilder, proxy_center_ref_period_fromInput, proxy_center_ref_period_toInput, proxy_center_ref_period_toSilder);
const calibration_anom_period_fromSilder = document.getElementById("calibration_anom_period_fromSilder");
const calibration_anom_period_toSilder = document.getElementById("calibration_anom_period_toSilder");
const calibration_anom_period_fromInput = document.getElementById("calibration_anom_period_fromInput");
const calibration_anom_period_toInput = document.getElementById("calibration_anom_period_toInput");
fillSlider(calibration_anom_period_fromSilder, calibration_anom_period_toSilder, "#C6C6C6", "#896A67", calibration_anom_period_toSilder);
setToggleAccessible(calibration_anom_period_toSilder);
calibration_anom_period_fromSilder.oninput = () => controlFromSlider(calibration_anom_period_fromSilder, calibration_anom_period_toSilder, calibration_anom_period_fromInput);
calibration_anom_period_toSilder.oninput = () => controlToSlider(calibration_anom_period_fromSilder, calibration_anom_period_toSilder, calibration_anom_period_toInput);
calibration_anom_period_fromInput.onchange = () => controlFromInput(calibration_anom_period_fromSilder, calibration_anom_period_fromInput, calibration_anom_period_toInput, calibration_anom_period_toSilder);
calibration_anom_period_toInput.onchange = () => controlToInput(calibration_anom_period_toSilder, calibration_anom_period_fromInput, calibration_anom_period_toInput, calibration_anom_period_toSilder);
const calibration_interval_fromSilder = document.getElementById("calibration_interval_fromSilder");
const calibration_interval_toSilder = document.getElementById("calibration_interval_toSilder");
const calibration_interval_fromInput = document.getElementById("calibration_interval_fromInput");
const calibration_interval_toInput = document.getElementById("calibration_interval_toInput");
fillSlider(calibration_interval_fromSilder, calibration_interval_toSilder, "#C6C6C6", "#896A67", calibration_interval_toSilder);
setToggleAccessible(calibration_interval_toSilder);
calibration_interval_fromSilder.oninput = () => controlFromSlider(calibration_interval_fromSilder, calibration_interval_toSilder, calibration_interval_fromInput);
calibration_interval_toSilder.oninput = () => controlToSlider(calibration_interval_fromSilder, calibration_interval_toSilder, calibration_interval_toInput);
calibration_interval_fromInput.onchange = () => controlFromInput(calibration_interval_fromSilder, calibration_interval_fromInput, calibration_interval_toInput, calibration_interval_toSilder);
calibration_interval_toInput.onchange = () => controlToInput(calibration_interval_toSilder, calibration_interval_fromInput, calibration_interval_toInput, calibration_interval_toSilder);
const calibration_regrid_latSilder = document.getElementById("calibration_regrid_latSilder");
const calibration_regrid_latInput = document.getElementById("calibration_regrid_latInput");
calibration_regrid_latSilder.oninput = () => changeInput(calibration_regrid_latSilder, calibration_regrid_latInput);
calibration_regrid_latInput.onchange = () => changeSlider(calibration_regrid_latInput, calibration_regrid_latSilder);
fillSingleSlider(calibration_regrid_latSilder)
const calibration_regrid_lonSilder = document.getElementById("calibration_regrid_lonSilder");
const calibration_regrid_lonInput = document.getElementById("calibration_regrid_lonInput");
calibration_regrid_lonSilder.oninput = () => changeInput(calibration_regrid_lonSilder, calibration_regrid_lonInput);
calibration_regrid_lonInput.onchange = () => changeSlider(calibration_regrid_lonInput, calibration_regrid_lonSilder);
fillSingleSlider(calibration_regrid_lonSilder)
var proxy_archiveType_checkCycle = 0;
function proxy_archiveType_incrementCheckCycle(){
